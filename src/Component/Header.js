        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex md:order-2">
            ...
            <div className='hidden md:flex'>
              <select name='search' value={fillterString} onChange={(e)=> setFillterString(e.target.value)} className="p-2 w-[65px] text-sm text-gray-900 border rounded-r-none border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option  className='text-gray-600 dark:text-gray-300 font-black'>By:</option>
              ...
              <div className="relative hidden md:block">
                ...
                <input value={searchString} onChange={handleInput} placeholder={"by "+" " + fillterString} type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-gray-900 border rounded-l-none border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
              </div>
            </div>
          ...
          <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
            <div className='flex items-center mt-3 md:hidden'>
              ...
              <div className="relative md:hidden w-full">
                ...
                <input value={searchString} onChange={handleInput} placeholder={"by "+" " + fillterString} type="text" id="search-navbar" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-l-none rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
              </div>
            ...
            <li>
              ...
              <li>
                <Link to='/login' onClick={logOut} className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">{user.token ? 'Logout' : 'Login'} </Link>
              </li>
              <li>
